...
#define STRING_CONFIG_H_AUTHOR "u/minist3r and u/indemnity83" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro V1.5 w/ Sprite and CRTouch"
...
// Resistor values when using MAX31865 sensors (-5) on TEMP_SENSOR_0 / 1
  ...
  #define TEMP_CHAMBER_PIN 37             // The pin to be used for the chamber temp sensor
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ender 3 v2
    ...
    #define DEFAULT_Kp_LIST {  17.21,  17.21 }
    #define DEFAULT_Ki_LIST {   1.51,   1.51 }
    #define DEFAULT_Kd_LIST {  48.88,  48.88 }
  #else
    #define DEFAULT_Kp 17.21
    #define DEFAULT_Ki 1.51
    #define DEFAULT_Kd 48.88
  #endif
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -32, -41, -1.9 }
